...
import SubjectFormDialog from "../../../components/Subjects/SubjectForm";

export default function SubjectsPage() {
  const router = useRouter();
  const { data: subjects, isLoading, refetch } = useListSubjectsQuery();
  // for reset the size of column
  ...
  return (
    <Box sx={{ p: 3, maxWidth: "100%", minWidth: 200, height: "300px" }}>
      <Card>
        <CardContent>
          <Stack
            direction="row"
          ...
          >
            ...
            <div className="flex">
              ...
              >
                Add Subject
                <AddOutlinedIcon className="ms-1" fontSize={"small"} />
              </Button>
              <Button
              ...
              >
                Reset View
                <RestoreIcon className="ms-1" fontSize={"small"} />
              </Button>
            </div>
          </Stack>
          <Card>
