      ...
      menuItems: [
        {
          ...
          children: [
            { label: t("Departments"), route: `/${locale}/departments` },
            { label: t("Students"), route: `/${locale}/students` },
            { label: t("Subjects"), route: `/${locale}/subjects` },
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      <aside
        className={`/* Mobile toggle */
          fixed top-0 z-9999 flex
          h-screen w-72 transform
          flex-col
          overflow-y-auto bg-black text-white transition-transform
          
          duration-3000 ease-linear dark:bg-boxdark lg:sticky
